...
export function createCollection(values: {
  ...
  return request1.post("/api/v2/admin/collection/create", {
    title,
    desc,
    sort,
    type,
...
export function editCollection(body: {
  ...
  return request1.post("/api/v2/admin/collection/edit", {
    id: collection_id,
    title,
    desc,
    sort,
...
export function deleteCollection(body: { collection_id: string }) {
  ...
  return request1.post("/api/v2/admin/collection/delete", {
    id: collection_id,
  });
}
