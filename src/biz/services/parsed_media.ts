...
export function setParsedMediaProfile(body: {
  ...
  return request1.post<void>("/api/v2/admin/parsed_media/set_profile", {
    parsed_media_id,
    media_profile,
  });
}
...
export function setParsedMediaProfileInFileId(body: {
  ...
  return request1.post<void>("/api/v2/admin/parsed_media/set_profile_in_file_id", {
    file_id,
    media_profile,
  });
}
...
export function setParsedSeasonMediaSourceProfile(body: {
  ...
  return request1.post<void>("/api/v2/admin/parsed_media_source/set_profile", {
...
export function deleteParsedMedia(params: { parsed_media_id: string }) {
  ...
  return request1.post("/api/v2/admin/parsed_media/delete", {
    id: parsed_media_id,
  });
}
/**
...
export function deleteParsedMediaSource(params: { parsed_media_source_id: string }) {
  ...
  return request1.post("/api/v2/admin/parsed_media_source/delete", {
    parsed_media_source_id,
  });
}